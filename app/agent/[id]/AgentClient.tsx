            ...
            <div>
              ...
              <div style={{ width: '100%', background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: '36px 40px', marginBottom: 28, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20 }}>
                ...
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                  ...
                  {isElectron && (
                    <button onClick={() => router.push(`/desktop-mode?agentId=${agent.id as string}`)} className="btn btn-outline" style={{ height: 44, padding: '0 20px', fontSize: 14, fontFamily: 'var(--sidebar-font)', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                      <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
                      Desktop Mode
                    </button>
                  )}
